...
{
    /// <summary>
    /// Атрибут позволяет указать поле по которому будет вести фильтрация.
    /// </summary>
    public class FilteredByAttribute : Attribute
    {
        /// <summary>
        /// Название поля по которому будет вести фильтрация
        /// </summary>
        ...
        /// </summary>
        /// <param name="FilteredProperty">Название поля по которому будет вести фильтрация</param>
